...
function createChildReconciler(
  ...
  function reconcileSingleElement(
    ...
    if (element.type === REACT_FRAGMENT_TYPE) {
      let created;
      if (enableFragmentRefs && element.props.ref !== null) {
        created = createFiberFromElement(element, returnFiber.mode, lanes);
        coerceRef(created, element);
      } else {
        created = createFiberFromFragment(
          element.props.children,
          returnFiber.mode,
          lanes,
          element.key,
  ...
  function reconcileChildFibersImpl(
    ...
    const isUnkeyedUnrefedTopLevelFragment =
      ...
      newChild.key === null &&
      (enableFragmentRefs ? newChild.props.ref === null : true);
